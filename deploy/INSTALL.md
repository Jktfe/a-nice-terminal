...
Run from this repo root (`/Users/jamesking/CascadeProjects/ant`):

```sh
bun run build
cp deploy/com.ant.fresh.plist /Users/jamesking/Library/LaunchAgents/com.ant.fresh.plist
launchctl bootstrap "gui/$(id -u)" /Users/jamesking/Library/LaunchAgents/com.ant.fresh.plist
...
runs `/Users/jamesking/.nvm/versions/node/v22.22.1/bin/node
...
rm /Users/jamesking/Library/LaunchAgents/com.ant.fresh.plist
```
