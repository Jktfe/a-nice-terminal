...
import {
  ...
  readCwdFromQwenLine, encodedCwdSegmentForQwen
...
describe('encodedCwdSegmentForQwen', () => {
  it('replaces all slashes with dashes including leading', () => {
    expect(encodedCwdSegmentForQwen('/Users/jamesking/CascadeProjects/a-nice-terminal'))
      .toBe('-Users-jamesking-CascadeProjects-a-nice-terminal');
  });
});
