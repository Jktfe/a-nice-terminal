...
describe('setTerminalLastPath', () => {
  it('persists a non-empty path', () => {
    ...
    expect(setTerminalLastPath(t.id, '/Users/jamesking/CascadeProjects/a-nice-terminal')).toBe(true);
    expect(getTerminalById(t.id)?.last_path).toBe('/Users/jamesking/CascadeProjects/a-nice-terminal');
  });
