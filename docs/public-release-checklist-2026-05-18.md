...
Run from `/Users/jamesking/CascadeProjects/ant`:
...
| Repo | Result |
|---|---|
| `/Users/jamesking/CascadeProjects/ant` | PASS, with internal-doc exclusion warning |
| `/Users/jamesking/CascadeProjects/a-nice-terminal` | PASS |
