...
If ANY of these are missing, the kimi PR description must call out what's needed; @homebrewmainclaude or JWPK provides the missing config.
...
VERSION=$(plutil -extract CFBundleShortVersionString raw "${ANTCHAT_REPO}/Antchat/Info.plist")
