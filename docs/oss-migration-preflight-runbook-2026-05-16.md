...
| Repo | Result | Notes |
|---|---|---|
| `/Users/you/CascadeProjects/ant` | PASS | AGPL docs/package metadata present. Warning: 11 private staging docs must remain excluded from public target. |
| `/Users/you/CascadeProjects/a-nice-terminal` | PASS without `--require-clean` | Public release posture passes after shared scanner excludes are applied. |
| `/Users/you/CascadeProjects/a-nice-terminal` | FAIL with `--require-clean` | Expected current block: the target worktree has owner-lane dirty/untracked files. Do not run the real migration copy until those files are committed, stashed, or explicitly cleared by their owner. |
...
cd /Users/you/CascadeProjects/a-nice-terminal
git status --short
node /Users/you/CascadeProjects/ant/scripts/check-oss-migration-preflight.mjs \
  --root /Users/you/CascadeProjects/a-nice-terminal \
  --public-target \
  --require-clean
test -f package.json
...
```sh
cd /Users/you/CascadeProjects/a-nice-terminal
PATH=/Users/you/.nvm/versions/node/v22.22.1/bin:$PATH bun run check
PATH=/Users/you/.nvm/versions/node/v22.22.1/bin:$PATH bun run build
```
...
ln -sfn /Users/you/CascadeProjects/a-nice-terminal/dist/ant-aarch64-apple-darwin ~/.bun/bin/ant
```
