...
| Swift iOS TestFlight Build 59 | Native iOS app | Adaptive ANT surface colours follow system dark/light. TestFlight install via james@newmodel.vc invite | Just shipped 2539dbf (swift first overnight deploy at 00:54:47Z). JWPK install path on iPhone/iPad now complete | ✓ |
