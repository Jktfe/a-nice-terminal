...
4. **Domain naming**: Keep `<ANT_SERVER_HOST>`, or request a custom domain (e.g., `ant.you.dev`)?
...
- #55 Phase 2 v4 CLI binary cutover: `/Users/you/.claude/plans/abstract-kindling-fiddle.md`
