...
| GitHub Code search for `kingfisher` / `redacted@example.com` | Did any redactable leak survive? | If yes → private revert + force-rewrite (the ONE acceptable destructive op post-launch); announce the corrective action transparently |
