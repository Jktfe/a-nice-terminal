...
**Licensor**: New Model Venture Capital Ltd ("Licensor")
...
1. Email **the maintainers via GitHub (github.com/Jktfe/a-nice-terminal)** with:
...
**the maintainers via GitHub (github.com/Jktfe/a-nice-terminal)** — Licensor, New Model Venture Capital Ltd
