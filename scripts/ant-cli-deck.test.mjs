...
describe('deckRootsFromEnv', () => {
  it('returns configured roots first and preserves Dropbox paths with spaces', () => {
    const dropbox = '/Users/you/Dropbox/Decks/ANTdecks';
    const roots = deckRootsFromEnv({ ANT_BUILT_DECKS_ROOTS: `${dropbox}:/tmp/other` }, '/Users/you');
    expect(roots[0]).toBe(dropbox);
    expect(roots[1]).toBe('/tmp/other');
    expect(roots[2]).toBe('/Users/you/CascadeProjects/ANT-Decks');
  });
});
