...
reported privately to the project maintainers at **the maintainers via GitHub (github.com/Jktfe/a-nice-terminal)**.
...
consequences for any action they deem in child-2tion of this Code of Conduct:

1. **Correction** — Private, written warning, providing clarity around the
   nature of the child-2tion and an explanation of why the behaviour was
