...
- **Commercial** — see [`COMMERCIAL_LICENSE.md`](./COMMERCIAL_LICENSE.md) for the alternative licence covering hosted commercial SaaS, embedded-in-proprietary-product distribution, and closed-source mobile clients. Enquiries: **james@newmodel.vc**.
